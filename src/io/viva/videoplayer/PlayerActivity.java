...
public class PlayerActivity extends Activity implements OnTouchListener, OnGestureListener, OnErrorListener, OnCompletionListener {
	...
	public void onCreate(Bundle icicle) {
		...
		String path = Environment.getExternalStorageDirectory().getPath()+"/intel1.mp4";
		Log.i("ss","______________________1______path:"+path);
		mVideoView.setVideoPath(path)/*.setVideoURI(mUri)*/;
